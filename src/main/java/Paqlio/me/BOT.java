...
import Paqlio.me.ListenersAdapters.MemberJoin;
import Paqlio.me.ListenersAdapters.Ticket;
    ...
    public void onEnable() {
        try {
            ...
            jda.updateCommands()
                    ...
                    .queue();
        jda.addEventListener(new Ticket(), new ButtonsInteractions(), new MemberJoin());
        } catch (Exception e) {
